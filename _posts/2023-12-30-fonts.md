...
{% include figure.liquid path="assets/img/tgt.jpeg" class="img-fluid rounded z-depth-1 center" width = "70%"%}
...
{% include figure.liquid path="assets/img/newtx.jpeg" class="img-fluid rounded z-depth-1 center" width = "70%" %}
...
\setmonofont{inconsolata}
```
{% include figure.liquid path="assets/img/tgp.jpeg" class="img-fluid rounded z-depth-1 center" width = "70%" %}
...
{% include figure.liquid path="assets/img/newpx.jpeg" class="img-fluid rounded z-depth-1 center" width = "70%" %}
...
{% include figure.liquid path="assets/img/erewhon.jpeg" class="img-fluid rounded z-depth-1 center" width = "70%" %}
...
{% include figure.liquid path="assets/img/ebgl.jpeg" class="img-fluid rounded z-depth-1 center" width = "70%" %}
...
{% include figure.liquid path="assets/img/ebg.jpeg" class="img-fluid rounded z-depth-1 center" width = "70%" %}
